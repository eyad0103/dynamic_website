// Persistent API Key System - File-based storage with proper recognition
const fs = require('fs');
...
function loadApiKeys() {
    try {
        ...
        if (fs.existsSync(API_KEY_FILE)) {
            ...
            console.log('🔑 API keys loaded from persistent storage');
            return keys;
        } else {
...
function createApiKeyRoutes() {
    ...
    router.get('/api/get-api-key', (req, res) => {
        try {
            ...
            if (keys.openrouter) {
                console.log('🔑 API key retrieved from persistent storage');
