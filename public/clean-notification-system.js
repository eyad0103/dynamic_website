// Clean Notification System - Single container, no stacking, auto-dismiss
let currentNotification = null;
let notificationQueue = [];
let isShowingNotification = false;

// Single notification system - prevents stacking completely
function showNotification(type, title, message, duration = 5000) {
    ...
    // If another notification is showing, queue this one
